---
layout: post
title: "Stop Overusing Spark: 80% of Workloads Don't Need It"
date: 2024-01-15
categories: data-engineering
tags: [spark, performance, optimization, system-design]
---
...
Key techniques to make BigQuery economical and fast If you switch, you must learn to think differently. Spark tuning = executors & shuffle; BigQuery tuning = schema and bytes.
...
- Why Spark is overused in the industry
- The hidden costs and complexity of distributed computing
- When Spark actually makes sense
- Simpler alternatives for common use cases
- Real-world examples of unnecessary complexity
